...
**AV-решения** детектируют статические индикаторы: 
- импорты недокументированных функций (`RtlAdjustPrivilege`, `NtRaiseHardError`)
- подозрительные строки в секциях `.rdata` / `.text`
- аномалии PE-структуры, характерные для обфусцированных или кастомно скомпилированных бинарных файлов
