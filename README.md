...
Разработка в процессе. Набор тестов будет увеличиваться.

Ниже будет находится описание реализованного функционала. Формат можно понять на примере уже реализованного BSOD thrower:
